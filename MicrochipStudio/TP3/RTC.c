...
void RTC_SetDateTime(rtc_t *data){
	...
	I2C_Write(DS3231WriteMode); // Conectarse al DS3231 enviando su ID en el bus I2C
...
void RTC_GetDateTime(rtc_t *data){
	...
	I2C_Start(); // Iniciar la comunicación I2C
	I2C_Write(DS3231ReadMode); // Conectarse al DS1307 (modo de lectura) enviando su ID
